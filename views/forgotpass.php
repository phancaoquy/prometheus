        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4>Now! Let's start change your password</h4>
              <form action="index.php?pgs=forgotpass" method="post" class="pt-3">
              
                <div class="form-group">
                  <input type="email" class="form-control form-control-lg" id="exampleInputEmail1" name="usr_email" placeholder="Email">
                </div>
                <div class="mt-3">
                  <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" name="btn_reset">Đổi mật khẩu mới</button>
                </div>
                <div class="text-center mt-4 font-weight-light">
                  Don't have an account? <a href="index.php?pgs=register" class="text-primary">Create</a>
                </div>
              </form>
            </div>
          </div>
