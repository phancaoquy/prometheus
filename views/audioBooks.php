...
$html_language = lang_list_audioBooks($lang_list);
$html_categ = categs_list_audioBooks($categs_list);
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9">
                <div class="row">
                    ...
                    <?php
                    if (isset($_GET['pgs']) && $_GET['pgs'] == "audioBooks") {
                        ...
                        WHERE  books.fm_id = 3 and book_categories.categ_id = $categ_id
                       ORDER BY id ASC limit $start, $limit");
                        ...
                        <a class="page-link" href="index.php?pgs=audioBooks&page=1"> <i class="fa fa-angle-left"></i>
                        </a>
                        ' . $pagLink_audioBooks . '
                        
                        <a class="page-link" href="index.php?pgs=audioBooks&page=' . $total_pages . '"> <i class="fa fa-angle-right"></i>
                        </a>
