...
$html_language = lang_list_ebooks($lang_list);
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9">
                <div class="row">
                    ...
                    <?php
                    if (isset($_GET['pgs']) && $_GET['pgs'] == "eBooks") {
                       ...
                       ORDER BY id ASC limit $start, $limit");
                        ...
                        <a class="page-link" href="index.php?pgs=eBooks&page=1"> <i class="fa fa-angle-left"></i>
                        </a>
                        ' . $pagLink_ebooks . '
                        
                        <a class="page-link" href="index.php?pgs=eBooks&page=' . $total_pages . '"> <i class="fa fa-angle-right"></i>
                        </a>
